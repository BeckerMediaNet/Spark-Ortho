...
//    // Unregister the built-in version of jQuery from WordPress
	...
	// jQuery from CDN
	wp_register_script( 'jquery', '//cdnjs.cloudflare.com/ajax/libs/jquery/3.6.1/jquery.min.js', [], null, true );
	wp_register_script( 'jquery-core', '', [ 'jquery' ], null, true );


	// Main app JS
	wp_enqueue_script( 'lvl-bootstrap', LVL_THEME_URI . lvl_cache_bust( '/dist/js/bootstrap.min.js' ), [], null, true );
	wp_enqueue_script( 'lvl-main-scripts', LVL_THEME_URI . lvl_cache_bust( '/dist/js/app.min.js' ), [ 'lvl-bootstrap', 'jquery' ], null, true );
